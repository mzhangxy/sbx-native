...
AUTO_ACCESS = os.environ.get('AUTO_ACCESS', 'false').lower() in ('true', 'yes') 
YT_WARPOUT = os.environ.get('YT_WARPOUT', 'false').lower() in ('true', 'yes')   
FILE_PATH = os.environ.get('FILE_PATH', '.cache')  # 运行时文件存储路径，默认当前目录下的.cache文件夹
SUB_PATH = os.environ.get('SUB_PATH', 'sub')       # 获取订阅节点的token
UUID = os.environ.get('UUID', '6cc44cc9-b96c-4532-a0fb-62561651849f') 
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', '') 
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')     
NEZHA_KEY = os.environ.get('NEZHA_KEY', '')       
ARGO_PORT = int(os.environ.get('ARGO_PORT', '59001')) 
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'temalix.1791765.xyz')  
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZDY1NWNiOTk2NzNlZTYzMDE4NDFkMmQyNmYxNTY5N2EiLCJ0IjoiYjgxMjA2NmUtNDBmYS00NmU2LWE3YjEtODdjNzFmOTlmZWJjIiwicyI6IlpUTm1aVGM1WWpNdE1URTJZaTAwWmpabUxXSTRZV1V0TUdRM1pUQTBOalV4TnpBMyJ9')      
...
CHAT_ID = os.environ.get('CHAT_ID', '8093926960')    
BOT_TOKEN = os.environ.get('BOT_TOKEN', '8396677288:AAGCpsBEDOjKkQuuNZgk7U3xanOsKS2M6U8')     
DISABLE_ARGO = os.environ.get('DISABLE_ARGO', 'false').lower() in ('true', 'yes') 
SHOW_LOG = os.environ.get('SHOW_LOG', 'true').lower() not in ('false', 'disable', 'no')  
# ==============================================================
