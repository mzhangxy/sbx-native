...
const ARGO_DOMAIN    = process.env.ARGO_DOMAIN    || 'belmo.ncc.kdns.fr';         // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH      = process.env.ARGO_AUTH      || 'eyJhIjoiZDY1NWNiOTk2NzNlZTYzMDE4NDFkMmQyNmYxNTY5N2EiLCJ0IjoiMWQzNDM1OTYtZDJhMi00ZTFhLTgzNDYtMDI3OThlOTIxNzdiIiwicyI6IlpqQmpOREJtTnpNdE56UTBOQzAwWm1NMkxUbGxabUV0TVRaaFlUaGlPV1ZqWkRjMSJ9';         // argo固定隧道token或json,留空即使用临时隧道
