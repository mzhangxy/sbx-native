...
UUID = os.environ.get('UUID', '00da1b5a-fa68-40cc-9eae-3bfdb64e5e99') # 节点和哪吒v1使用的UUID，默认固定值，建议自行生成一个唯一的UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'belmo.ncc.kdns.fr')  # 固定隧道域名，留空将使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZDY1NWNiOTk2NzNlZTYzMDE4NDFkMmQyNmYxNTY5N2EiLCJ0IjoiMWQzNDM1OTYtZDJhMi00ZTFhLTgzNDYtMDI3OThlOTIxNzdiIiwicyI6IlpqQmpOREJtTnpNdE56UTBOQzAwWm1NMkxUbGxabUV0TVRaaFlUaGlPV1ZqWkRjMSJ9')      # 固定密钥token或json，留空将使用临时隧道
...
NAME = os.environ.get('NAME', 'Belmo')               # 节点名称前缀
CHAT_ID = os.environ.get('CHAT_ID', '8093926960')         # Telegram机器人ID，例如1001234567890
BOT_TOKEN = os.environ.get('BOT_TOKEN', '8396677288:AAGCpsBEDOjKkQuuNZgk7U3xanOsKS2M6U8')     # Telegram机器人Token，例如123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew11
